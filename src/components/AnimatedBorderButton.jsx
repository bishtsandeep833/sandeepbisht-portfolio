...
export const AnimatedBorderButton = ({children}) => {
    return (                      
      <button
       ...
       group px-5 py-4 text-lg font-medium rounded-full overflow-visible animated-border'>
                            {/* Animated SVG Border */}
                            <svg
                            className='absolute left-0 top-0 w-full h-full pointer-events-none animate-border border-primary' 
                            viewBox='0 0 200 60'
