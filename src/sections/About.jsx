                    ...
                    <span className="font-serif italic font-normal text-white"> one component at a time.</span>
                     ...
                     <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
                        <p>
                            ...
                            web, and it has evolved into a deep expertice in modern frontend technologies.
                        </p>
                        <p>
                            I specialize in MERN stack MONGO DB, EXPRESS.js, REACT.js, and NODE.js building
                            everything from sleek landing pages to complex enterprise applications.
                            My approach combines technical excellance with a keen eye for design and user experience.
                        </p>
                        <p>
                     ...
                     <div className="glass rounded-2xl p-6 glow-border animate-fade-in animation-delay-300">
                        <p className="text-lg font-medium italic text-foreground">
                            ...
                            truly delightful and meaningful - products that users love to maintain."
                        </p>
                     </div>
                </div>
                {/* Right Column */}
