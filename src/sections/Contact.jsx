...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "bishtsandeep833@gmail.com",
        href: "mailto:bishtsandeep833@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
    ...
    return( <section id="contact" className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <h2 className="text-4xl md:text-5xl font-bold mt-4 mb-6 animate-fade-in animation-delay-200 text-primary">
                    Let's build{" "}
                ...
                <div  className="glass p-8 rounded-3xl border border-primary/30 animate-fade-in animation-delay-300">
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        {submitStatus.type && (
                            ...
                            ${
                            submitStatus.type === "success" ? "bg-green-500/10 border-green-500/20 text-green-500"
                ...
                <div className="space-y-6 animate-fade-in animation-delay-400">
                    ...
                    <div className="glass rounded-3xl p-8 border border-primary/30">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <span className="font-medium">Currntly Available</span>
                        </div>
